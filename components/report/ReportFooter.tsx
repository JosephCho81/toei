...
export function ReportFooter({ roundLabel, today }: { roundLabel: string; today: string }) {
  return (
    <>
      {/* 푸터 */}
      <footer className="mt-8 pt-4 border-t border-gray-200 text-sm text-muted-foreground flex justify-between items-center">
      ...
      <div className="hidden print:block mt-8 break-before-page">
        <p className="text-sm text-muted-foreground mb-2 text-center">결재</p>
